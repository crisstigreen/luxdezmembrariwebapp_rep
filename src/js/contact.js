...
function initMap() {
        const location = { lat: 46.9243392, lng: 26.9810409 };
    ...
    position: { lat: 46.9243392, lng: 26.9810409 },
    map: map,
    title: "Custom Marker",
    icon: {
        url: "http://localhost:8080/images/marker.svg", // URL to the custom marker image
